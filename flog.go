/*
Package FLog v3 provides a flexible and extendable logging framework for the MTGO-Launcher application. It supports various log types and allows you to control log output both to files and the console.
FLog v3
Usage:
...
func Init() error {
	...
	logFolder := filepath.Join(appDataDir, appSubdir)
	if err != nil {
		return err
	}
